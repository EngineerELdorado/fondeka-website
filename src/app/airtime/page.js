  ...
  return (
    <main className="section">
      <div className="container-pad grid md:grid-cols-2 gap-10 items-start">
        <div>
          <h1 className="h">{t('product.airtime.title')}</h1>
          <p className="mt-3 text-gray-700">{t('product.airtime.body')}</p>
        ...
        <div className="card">
          <img src="https://images.unsplash.com/photo-1517433456452-f9633a875f6f?q=80&w=1200" alt="" className="w-full h-80 object-contain" />
        </div>
      </div>
    </main>
  );
