...
export const seoKeywords = [
  ...
  'bill payments Congo',
  'pay utility bills online Congo',
  'pay electricity bills online Congo',
  'pay SOCODEE online',
  'pay Virunga online',
  'pay SNEL online',
...
export const serviceSeo = {
  ...
  bills: {
    path: '/bills',
    name: 'Bill Payments',
    title: 'Bill Payments in Congo: SOCODEE, Virunga, SNEL, Canal Plus | Fondeka',
    description:
      'Pay supported SOCODEE, Virunga, SNEL, Canal Plus, electricity, water, TV, internet, airtime, data, and digital product bills from one Fondeka account.',
    keywords: [
      'bill payments Congo',
      'pay bills Congo',
      'pay bills Africa',
      'bill payment app Congo',
      'best bill payment app Congo',
      'pay utility bills online Congo',
      'pay electricity bills online Congo',
